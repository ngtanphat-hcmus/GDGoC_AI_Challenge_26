"""
AlphaSearch Agent V8 — Competition-Ready Bomberland AI
GDGoC-HCMUS AI Challenge 2026

Built on V7 + Checkmate Engine:
  1. Perfect Trap Detection: mathematically proves enemy death using temporal BFS.
  2. Map Domination: positional center bias during idle.
  3. Dynamic Aggression: scales bomb threshold down in 1v1 and late game.
"""
import numpy as np
...
def _simulate_enemy_trapped(grid, mpos, radius, enemy_pos, bombs, players, agent_id):
    """Simulate placing a bomb at mpos and check if enemy has ANY valid temporal escape."""
...
class Agent:
    ...
    def _bomb_value(self, grid, mpos, radius, bombs, bset, enemies, eset, dm, hazard, blk, players):
        ...
        # ─── ADDITION 1: Perfect Trap Simulation (Checkmate) ────────────
        e_trapped_sim = 0
        for ex, ey in enemies:
