"""
AlphaSearch Agent V10 — Competition-Ready Bomberland AI
GDGoC-HCMUS AI Challenge 2026

Built on V9 + The Immortal Engine:
  1. Realistic Safety Horizon: max_d=14 for survival escaping.
  2. Enhanced Corridor Aversion: never enter a 1-exit tile if enemy is near.
  3. Softened Center Bias & Expanded Threat Modeling (d<=4).
  4. Removed Item Denial to prevent suicidal greed.
"""
import numpy as np
...
class Agent:
    ...
    def _should_bomb(self, grid, mpos, radius, bombs, pot_bombs, bset,
        ...
        if esc_action in ACT_D:
            ...
            # V10 Corridor Aversion: If enemy is near, do not enter a 1-exit corridor
            if esc_exits <= 1 and min_enemy_dist <= 4:
                return False
